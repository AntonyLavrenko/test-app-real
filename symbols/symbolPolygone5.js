var SymbolPolygone5 = function () {
    ...
    this.getArea = function () {
        ...
        var p5 = (this.points[4][0] * this.points[0][1]);
        var p6 = (this.points[1][0] * this.points[0][1]);
        var p7 = (this.points[2][0] * this.points[1][1]);
        var p8 = (this.points[3][0] * this.points[2][1]);
        var p9 = (this.points[4][0] * this.points[3][1]);
        var p10 = (this.points[0][0] * this.points[4][1]);

        return (Math.abs(p1 + p2 + p3 + p4 + p5 - p6 - p7 - p8 - p9 - p10)) * 0.5;
    }
};

SymbolPolygone5.prototype = Object.create(SymbolInterface.prototype);